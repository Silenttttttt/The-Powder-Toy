...
DEFINE_ELEMENT(KNO3, PT_NORMAL_NUM + 10)
DEFINE_ELEMENT(CO  , PT_NORMAL_NUM + 11)
DEFINE_ELEMENT(NA  , PT_NORMAL_NUM + 12)
DEFINE_ELEMENT(K   , PT_NORMAL_NUM + 13)
DEFINE_ELEMENT(KSO4, PT_NORMAL_NUM + 14)
DEFINE_ELEMENT(KCO3, PT_NORMAL_NUM + 15)
DEFINE_ELEMENT(SO4 , PT_NORMAL_NUM + 16)
DEFINE_ELEMENT(CU  , PT_NORMAL_NUM + 17)
DEFINE_ELEMENT(CASO, PT_NORMAL_NUM + 18)
DEFINE_ELEMENT(CA  , PT_NORMAL_NUM + 19)
DEFINE_ELEMENT(HSO4, PT_NORMAL_NUM + 20)
DEFINE_ELEMENT(S   , PT_NORMAL_NUM + 21)
DEFINE_ELEMENT(KNO2, PT_NORMAL_NUM + 22)
DEFINE_ELEMENT(ALO3, PT_NORMAL_NUM + 23)
DEFINE_ELEMENT(FEOX, PT_NORMAL_NUM + 24)
DEFINE_ELEMENT(POIL, PT_NORMAL_NUM + 25)
DEFINE_ELEMENT(SMKE, PT_NORMAL_NUM + 26)
#ifndef NOMOD
