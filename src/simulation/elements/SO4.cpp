...
int SO4_update(UPDATE_FUNC_ARGS)
{
	/*
	int temp = 0;
	int oxyposnum = 0;
...
void SO4_create(ELEMENT_CREATE_FUNC_ARGS)
{
...
void SO4_init_element(ELEMENT_INIT_FUNC_ARGS)
{
	elem->Identifier = "DEFAULT_PT_SO4";
	elem->Name = "SO4";
	...
	elem->Latent = 0;
	elem->Description = "Sulfate. Only used to make CaSO4.";
	...
	elem->Update = &SO4_update;
	elem->Func_Create = &SO4_create;
	//elem->Graphics = &COAL_graphics;
	elem->Init = &SO4_init_element;
}
